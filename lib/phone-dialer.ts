...
export type CopyPhoneForDialResult = "copied" | "copy_failed" | "missing"

/**
 * Copy lead number for dialling — never opens tel: or external apps (no redirect / app picker).
 */
...
/** @deprecated Use copyPhoneForDial — same behavior, no tel: redirect. */
